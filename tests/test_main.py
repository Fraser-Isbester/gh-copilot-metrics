    ...
    sample_data = [
        {
            ...
            "copilot_dotcom_pull_requests": {"total_engaged_users": 15, "repositories": []},
        }
    ]
...
def test_load_data_file_not_found():
    ...
    with patch("builtins.open", side_effect=FileNotFoundError), \
        ...
        mock_print.assert_any_call("[bold red]Error: File 'nonexistent.json' not found.[/bold red]")
...
def test_load_data_invalid_json():
    ...
    with patch("builtins.open", mock_open(read_data="invalid json")), \
        ...
        mock_print.assert_any_call("[bold red]Error: Invalid JSON data provided.[/bold red]")
...
def test_upload_to_bq_command():
    ...
    try:
        with patch("pilot_metrics.main.upload_to_bigquery") as mock_upload, \
             patch.dict("os.environ", {"GCP_PROJECT_ID": "test-project", "BQ_DATASET": "test-dataset"}):
