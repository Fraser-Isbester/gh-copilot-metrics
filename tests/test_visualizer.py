...
def test_create_dashboard_with_data():
    ...
    with patch('pilot_metrics.visualizer.pyo.plot') as mock_plot, \
...
def test_create_dashboard_browser_error():
    ...
    with patch('pilot_metrics.visualizer.pyo.plot') as mock_plot, \
         patch('pilot_metrics.visualizer.webbrowser.open', side_effect=Exception("Browser error")) as mock_browser, \
         patch('builtins.print') as mock_print:
        ...
        mock_print.assert_any_call("Could not open browser automatically: Browser error")
        mock_print.assert_any_call("Please open 'dashboard.html' manually in your browser")
